# Ejercicio en parejas - Módulo 2 Adalid Corfo
...
1. Clona el repositorio en tu máquina local:
    ...
    ```bash
    git clone https://github.com/Pabloblockchain24/ejercicio-parejas-modulo2-adalid-corfo.git
    ```

2. Navega a la carpeta del proyecto:

    ```bash
    cd ejercicio-parejas-modulo2-adalid-corfo
    ```
